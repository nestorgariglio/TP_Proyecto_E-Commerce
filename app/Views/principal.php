      ...
      <div id="carouselExampleIndicators" class="carousel slide">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="/TP_Proyecto_E-Commerce/public/assets/img/carrucel1.jpeg" class="img-fluid w-100" alt="...">
          </div>
          <div class="carousel-item">
            <img src="/TP_Proyecto_E-Commerce/public/assets/img/carrucel2.jpeg" class="img-fluid w-100" alt="...">
          </div>
          <div class="carousel-item">
            <img src="/TP_Proyecto_E-Commerce/public/assets/img/carrucel3.jpeg" class="img-fluid w-100" alt="...">
          </div>
        </div>
