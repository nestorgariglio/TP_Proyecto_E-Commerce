<footer class="w-100 d-flex align-items-center justify-content-center gap-3 py-4" style="background-color: #cf172e;">
  <div class="d-flex flex-column align-items-center gap-3" style="width: 58rem;">
    ...
    <div class="d-flex w-100 justify-content-center gap-3 text-center">
      <a href="https://www.instagram.com/quelac_corrientes?igsh=MWtjNXdxN2h2bWF5ag%3D%3D" target="_blank" class="fs-5 text-white"><i class="fa-brands fa-instagram"></i></a>
    </div>
    <span class="text-white" style="font-size: 13px;">@2025 Quelac. Todos los derechos reservados.</span>
  </div>
</footer>